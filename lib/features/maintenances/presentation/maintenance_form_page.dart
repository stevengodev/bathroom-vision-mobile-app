...
class _MaintenanceFormPageState extends State<MaintenanceFormPage> {
  ...
  void initState() {
    ...
    if (widget.maintenance != null) {
      ...
      scheduledDateTime = DateTime.parse(m.scheduledAt);
    }
  }
  ...
  Widget build(BuildContext context) {
    final bathrooms = context.watch<BathroomProvider>().bathrooms;
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                _title("Información del mantenimiento"),

                const SizedBox(height: 20),

                DropdownButtonFormField<int>(
                  value: selectedBathroomId,
                  decoration: _inputDecoration("Baño", Icons.bathroom),
                  items: bathrooms
                      .map(
                        (b) => DropdownMenuItem(
                          value: b.id,
                    ...
                    onPressed: () async {
                      ...
                      if (scheduledDateTime == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text("Selecciona fecha programada"),
                          ),
                        );
                        return;
                      }
                      ...
                      if (isEdit) {
                        ...
                        await provider.createMaintenance(request);
                      }
